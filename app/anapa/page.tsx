...
import { ChevronLeft, ChevronRight, MapPin, Users, Dumbbell, Waves, Car, UtensilsCrossed, Shield } from "lucide-react"
      ...
      <section className="py-12 bg-gradient-to-b from-muted/30 to-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" data-aos="fade-up" data-aos-delay="200">
            {[
              { icon: Dumbbell, title: "Спортивные объекты", features: ["Футбольное и баскетбольное поле","Тренажерный зал","Воркаут площадки","Площадка для тенниса"] },
              { icon: Waves, title: "Восстановление", features: ["Бассейн 25 метров","Сауна","Боулинг центр"] },
              { icon: UtensilsCrossed, title: "Питание", features: ["Трёхразовое питание — шведская линия","Меню для спортсменов"] },
              { icon: Users, title: "Проживание", features: ["Номера на 2—3 человека","Современные удобства"] },
              { icon: Shield, title: "Безопасность и сервис", features: ["Охраняемая территория","Медицинская помощь по запросу"] },
              { icon: Car, title: "Транспорт", features: ["Трансфер от/до вокзала и аэропорта","Парковка для автобусов"] },
            ].map((facility, index) => (
